...
| **`capture_complete`** | Whether the capture is whole, or was narrowed by the body policy / the read cap / a stream that ended early. Covers **both** bodies, request and response. | [internal/store/schema.sql](../../internal/store/schema.sql) |
